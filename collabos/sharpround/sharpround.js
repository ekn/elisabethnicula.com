...
var randomRect = function() {
    var rect;
    if (Math.random() > 0.5) {
        rect = Physics.body('rectangle', randomize({ width: 175, height: 110 }));
        rect.view = new Image();
        rect.view.src = "sharp.png";
    } else {
        rect = Physics.body('rectangle', randomize({ width: 150, height: 95 }));
        rect.view = new Image();
        rect.view.src = "round.png";
    }
